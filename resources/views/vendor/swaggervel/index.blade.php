...
<head>
    ...
    <script src='{{ url('/vendor/swaggervel/lib/object-assign-pollyfill.js') }}' type='text/javascript'></script>
    ...
    <script src='{{ url('/vendor/swaggervel/lib/handlebars-4.0.5.js') }}' type='text/javascript'></script>
    <script src='{{ url('/vendor/swaggervel/lib/lodash.min.js') }}' type='text/javascript'></script>
    ...
    <script src='{{ url('/vendor/swaggervel/lib/highlight.9.1.0.pack.js') }}' type='text/javascript'></script>
    <script src='{{ url('/vendor/swaggervel/lib/highlight.9.1.0.pack_extended.js') }}' type='text/javascript'></script>
    <script src='{{ url('/vendor/swaggervel/lib/jsoneditor.min.js') }}' type='text/javascript'></script>
...
<div id='header'>
    <div class="swagger-ui-wrap">
        <a id="logo" href="http://swagger.io"><img class="logo__img" alt="swagger" height="30" width="30"
                                                   src="{{ url('/vendor/swaggervel/images/logo_small.png') }}"/><span
...
<div id="oauth2-settings" class="swagger-ui-wrap">
    ...
    <input placeholder="Client Secret" id="input_clientSecret" name="clientSecret" type="text"
           value="{!! $clientSecret !!}"/>
    ...
    <br/>
    <span class="note">Configure OAuth2 Client with id="<span id="clientId"></span>" and redirect url="<span
                id="redirectUrl"></span>"</span>
</div>
